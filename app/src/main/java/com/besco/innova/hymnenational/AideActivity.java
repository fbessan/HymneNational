...
public class AideActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                Intent i = new Intent(com.besco.innova.hymnenational.AideActivity.this, com.besco.innova.hymnenational.MainActivity.class);
                startActivity(i);
                finish();
                return true;
            case R.id.action_liste:
                Intent intent = new Intent(com.besco.innova.hymnenational.AideActivity.this, com.besco.innova.hymnenational.ListeActivity.class);
            ...
            case R.id.menu_item_histoire:
                Intent intenthistoire = new Intent(com.besco.innova.hymnenational.AideActivity.this, com.besco.innova.hymnenational.HistoireActivity.class);
                startActivity(intenthistoire);
                break;
            case R.id.action_help:
                Intent intentaide = new Intent(com.besco.innova.hymnenational.AideActivity.this, com.besco.innova.hymnenational.AideActivity.class);
    ...
    private void initControls()
    {
        try
        {
            final Dialog dialog1 = new Dialog(AideActivity.this);
